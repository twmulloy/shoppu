...
ActiveRecord::Schema.define(version: 20170630024252) do
  ...
  create_table "alchemy_essence_spree_taxonomies", force: :cascade do |t|
    t.integer  "taxonomy_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["taxonomy_id"], name: "index_alchemy_essence_spree_taxonomies_on_taxonomy_id", using: :btree
  end
